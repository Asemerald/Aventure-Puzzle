...
public class DoorRelays : MonoBehaviour
{
    ...
    private void Update()
    {
        if (interactiblePowering.Count == interactiblesRequired.Length && !isPowered)
        {
        ...
        else if (interactiblePowering.Count != interactiblesRequired.Length && isPowered)
        {
